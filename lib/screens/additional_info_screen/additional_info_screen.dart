            ...
            children: [
                      ...
                      onTap: () {
                        Get.bottomSheet(
                          CustomWheeler(
                            ...
                            onChangedChoice: (val) {
                              _controller.yearOfExperience.value =
                                  _controller.yearOfExperienceList.elementAt(val);
                            },
                          ),
                        );
                      },
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: AppColors.themeColor))
                ),
              ),
              const SizedBox(height: 40),
              GestureDetector(
